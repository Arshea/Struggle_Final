...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private AudioClip[] m_JumpSound;           // an array of jump sounds played when character leaves the ground.
        [SerializeField] private AudioClip[] m_LandSound;           // an array of land sounds played when character touches back on ground.
